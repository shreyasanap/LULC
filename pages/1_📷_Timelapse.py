...
landsat_rois = {
    "Delhi": Polygon(
        [
            [76.8381, 28.4126],  # NW corner
            [77.3475, 28.4126],  # NE corner
            [77.3475, 28.8782],  # SE corner
            [76.8381, 28.8782],  # SW corner
        ]
    ),
    "Mumbai": Polygon(
        [
    ...
    "Kolkata": Polygon(
        [
            [88.2098, 22.3725],  # SW corner
            [88.5098, 22.3725],  # SE corner
            [88.5098, 22.7879],  # NE corner
            [88.2098, 22.7879],  # NW corner
        ]
    ),
}
